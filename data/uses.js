...
export const PAIR_DEVICES = {
  Computer: {
    icon: <FontAwesomeIcon icon={`fa-duotone fa-laptop ${iconClassName}`} />,
    model: 'MacBook Pro M1',
    id: 'minhtran-mac',
  },
  Smartphone: {
    icon: (
      <FontAwesomeIcon icon={`fa-duotone fa-mobile-notch ${iconClassName}`} />
    ),
    model: 'iPhone 13',
    id: 'minhtran-iphone',
  },
  Tablet: {
    icon: <FontAwesomeIcon icon={`fa-duotone fa-tablet ${iconClassName}`} />,
    model: 'iPad Pro 2021',
    id: 'minhtran-ipad',
  },
};
